    ...
    <div>
      <div>
        <div class="source f-flex">
          <p>{{$t('m.payRecords.record4')}}: {{$currency}} {{total_of.total_money || 0.00}}{{$numberUnit}}</p>
          <p>{{$t('m.payRecords.record5')}}: {{$currency}} {{total_of.rate_money || 0.00}}{{$numberUnit}}</p>
        </div>
      </div>
    </div>
    ...
    <div class="p20"
      ...
      <van-list v-model="loading"
        ...
        <div class="recordllist"
            ...
            <p>{{$t('m.payRecords.record3')}} &nbsp;{{item.financial_name}}&nbsp;{{$currency}} {{item.min_money}}{{$numberUnit}}</p>
        </div>
      </van-list>
    </div>
  </div>
